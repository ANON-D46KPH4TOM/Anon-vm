        ...
        -Invnvvnsi..___..=sv=.     `
          +Invnvnvnnnnnnnnvvnn;.
            ~|Invnvnvvnvvvnnv]+`
               ...
               ''')
    system('pkg install wget openssl-tool proot tar -y && hash -r && wget https://raw.githubusercontent.com/EXALAB/AnLinux-Resources/master/Scripts/Installer/Void/void.sh && bash void.sh')
elif os == '6':
    system('clear')
    print(f'''{greens}
                 ..
...
:KK{green}KKKKKKKKKK0o;...^cdxxOK0O/^^'  {green}.0K:
 ...
 `0K{green}KKKKKKKKKKKKKKKKKKKK00KKOo^  {green}c00`
  `kK{green}KKOxddxkOO00000Okxoc;``   {green}.dKk`
    ...
    ''')
    system('pkg install wget openssl-tool proot tar -y && hash -r && wget https://raw.githubusercontent.com/EXALAB/AnLinux-Resources/master/Scripts/Installer/openSUSE/Leap/opensuse-leap.sh && bash opensuse-leap.sh')
elif os == '8':
    system('clear')
    print(f'''{cyan}
                                     ......
...
.MM,                 .kMMl                       xMN
 ...
 .XM0.           ,OMMK,    OMMMK.              .XMK
   oWMO:.    .;xNMMk,       NNNMKl.          .xWMx
    ...
    ''')
    system('pkg install wget openssl-tool proot tar -y && hash -r && wget https://raw.githubusercontent.com/EXALAB/AnLinux-Resources/master/Scripts/Installer/openSUSE/Tumbleweed/opensuse-tumbleweed.sh && bash opensuse-tumbleweed.sh')
elif os == '9':
    system('clear')
    print(f'''{white}
                   00
